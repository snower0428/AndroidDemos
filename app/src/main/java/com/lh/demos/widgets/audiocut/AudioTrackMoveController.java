 ...
 * AudioTrackMoveController
 */

public class AudioTrackMoveController {
    ...
    public AudioTrackMoveController(int delayTime) {
        mDelayTime = delayTime;
    }

    public AudioTrackMoveController(int delayTime, OnProgressChangeListener listener) {
        mDelayTime = delayTime;
        mListener = listener;
    }
